...
<?php echo "WELCOME ".$login_session; ?><br>CLASS<br>COMPARTMENT
</th>
...
$sql = "INSERT into train_book(uname,train_no) values('$login_session','$final')";
    $ins=mysqli_query($conn,$sql);
    $sql="SELECT train_no a,class b,price c FROM fare where train_no='$final'";
    ...
    while($row=mysqli_fetch_assoc($res))
    {
        ...
        echo "<input type='hidden' name='kkkk' value='$y'>";
        echo "<td>" . $row['a'] . "</td>";
        echo "<td>" . $row['b'] . "</td>";
        echo "<td>" . $row['c'] . "</td>";
        echo "</tr>";
    ...
    ?>
        <br><br>
    <input type='submit' value='Click here ->To Book Ticket'></input>
    </form>
