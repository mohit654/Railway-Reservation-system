...
<input type="text" name="uname" id="t1" placeholder="Username" style="border-radius:100px;width:120px;"/><br><hr>
<input type="password" name="pass" id="t2" placeholder="Password" style="border-radius:100px;width:120px;"/><br><hr>
    <input type = "submit" value = " Submit "/><br />
</form>

<a href="reg14.php" style="text-decoration:none;">Register Here</a><br><hr>
