...
<?php echo "WELCOME ".$login_session; ?><br>TICKET<br>BOOKING
    </th>
...
$sql1 = "SELECT class a FROM fare WHERE  price=$price and train_no='$train_no'";
$res1=mysqli_query($conn,$sql1);
$row1=mysqli_fetch_assoc($res1);
$rr=$row1['a'];

$sql = "UPDATE train_book set price='$price',class='$rr' WHERE uname='$login_session'";
if(mysqli_query($conn,$sql))
{
    echo "Ticket booked successfully for " . $login_session . " for price " . $price."<br>" ;
    echo "Thank you for booking your ticket";
...
?>
<br>
<button><a href="reg21.php" target="blank">Click here to view ticket booked</a></button>
<br>
<button><a href="reg13.php" target="blank">Click here to go back to dashboard</a></button>
