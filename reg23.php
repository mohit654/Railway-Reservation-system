...
$sql = "DELETE FROM train_book WHERE uname='$login_session' and train_no='$train_no'";
if(mysqli_query($conn,$sql))
{
    echo "Ticket cancelled successfully for " . $login_session." Thank you for using our service"  ;
